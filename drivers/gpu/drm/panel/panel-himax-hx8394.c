...
#define HX8394_CMD_UNKNOWN7	  0xbc
...
static const struct drm_display_mode boe_tv070wsm_tl0_mode = {
	.hdisplay    = 600,
	.hsync_start = 600 + 120,
	.hsync_end   = 600 + 120 + 32,
	.htotal	     = 600 + 120 + 32 + 93,
	// .hdisplay    = 600,
	// .hsync_start = 600 + 40,
	// .hsync_end   = 600 + 40 + 32,
	// .htotal	     = 600 + 40 + 32 + 93,
...
static int boe_tv070wsm_tl0_init_sequence(struct hx8394 *ctx)
{
	struct mipi_dsi_device *dsi = to_mipi_dsi_device(ctx->dev);
	...
	/* 5.19.2 SETPOWER: Set power (B1h) */
	mipi_dsi_dcs_write_seq(dsi, HX8394_CMD_SETPOWER,
			       0x6C, 0x0E, 0x0E, 0x25, 0x04, 0x0F,
			       0xEF, 0x01, 0x68, 0xDA, 0x23, 0x86, 0xC0, 0x8A, 0x58);

	/* 5.19.3 SETDISP: Set display related register (B2h) */
	mipi_dsi_dcs_write_seq(dsi, HX8394_CMD_SETDISP,
			       0x85, 0x44, 0x0f, 0x09, 0x24, 0x1c, 0x08, 0x08, 0x1c, 0x4d, 0x00, 0x00, 0x30, 0x44, 0x48);
			       // 0x85, 0x20, 0x44, 0x08, 0x04, 0x1c, 0x08, 0x08, 0x1c, 0x4d, 0x00, 0x00, 0x30, 0x44, 0x48);

	/* 5.19.4 SETCYC: Set display waveform cycles (B4h) */
	mipi_dsi_dcs_write_seq(dsi, HX8394_CMD_SETCYC,
			       0x00, 0xff, 0x59, 0x5a, 0x59, 0x5a, 0x59, 0x5a, 0x01, 0x76, 0x01, 0x76,);

	/* Unknown command, not listed in the HX8394-F datasheet (BFh) */
	mipi_dsi_dcs_write_seq(dsi, HX8394_CMD_UNKNOWN5,
			       0x41, 0x0E, 0x01);
	...
	/* 5.19.19 SETGIP0: Set GIP Option0 (D3h) */
	mipi_dsi_dcs_write_seq(dsi, HX8394_CMD_SETGIP0,
			        0x00, 0x00, 0x00, 0x01, 0x07, 0x0c, 0x0c, 0x32, 0x10, 0x07, 0x00, 0x05, 0x00, 0x20, 0x0a, 0x05, 0x09, 0x00, 0x32, 0x10, 0x08, 0x00, 0x21, 0x21, 0x08, 0x07, 0x23, 0x0d, 0x07, 0x47);

	/* 5.19.20 Set GIP Option1 (D5h) */
	mipi_dsi_dcs_write_seq(dsi, HX8394_CMD_SETGIP1,
			       0x01, 0x00, 0x01, 0x00, 0x03, 0x02, 0x03, 0x02, 0x21, 0x20, 0x21, 0x20, 0x18, 0x02, 0x18, 0x02, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18);

	/* 5.19.11 Set register bank (BDh) */
	mipi_dsi_dcs_write_seq(dsi, HX8394_CMD_SETREGBANK,
			       0x02);

	/* Unknown command, not listed in the HX8394-F datasheet (D8h) */
	mipi_dsi_dcs_write_seq(dsi, HX8394_CMD_UNKNOWN4,
			       0xff, 0xff, 0xaa, 0xaa, 0xaa, 0xa0, 0xff, 0xff, 0xaa, 0xaa, 0xaa, 0xa0);

	/* 5.19.25 SETGAMMA: Set gamma curve related setting (E0h) */
	mipi_dsi_dcs_write_seq(dsi, HX8394_CMD_SETGAMMA,
			       0x00, 0x06, 0x0c, 0x28, 0x2d, 0x3d, 0x1a, 0x37, 0x07, 0x0a, 0x0d, 0x18, 0x0e, 0x12, 0x15, 0x13, 0x15, 0x06, 0x10, 0x11, 0x16, 0x00, 0x06, 0x0c, 0x28, 0x2c, 0x3d, 0x1a, 0x37, 0x07, 0x0a, 0x0c, 0x18, 0x0f, 0x12, 0x15, 0x13, 0x14, 0x06, 0x10, 0x11, 0x16, 0x00);
	...
	mipi_dsi_dcs_write_seq(dsi, HX8394_CMD_SETDGCLUT,
			       0x01, 0x00, 0x08, 0x10, 0x18, 0x20, 0x28, 0x30, 0x38, 0x40, 0x48, 0x50, 0x58, 0x60, 0x68, 0x70, 0x78, 0x80, 0x88, 0x90, 0x98, 0xa0, 0xa8, 0xb0, 0xb8, 0xc0, 0xc8, 0xd0, 0xd8, 0xe0, 0xe8, 0xf0, 0xf8, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
	...
	/* 5.19.12 SETDGCLUT: Set DGC LUT (C1h) */
	mipi_dsi_dcs_write_seq(dsi, HX8394_CMD_SETDGCLUT,
			        0x00, 0x08, 0x10, 0x18, 0x20, 0x28, 0x30, 0x38, 0x40, 0x48, 0x50, 0x58, 0x60, 0x68, 0x70, 0x78, 0x80, 0x88, 0x90, 0x98, 0xa0, 0xa8, 0xb0, 0xb8, 0xc0, 0xc8, 0xd0, 0xd8, 0xe0, 0xe8, 0xf0, 0xf8, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
	...
	/* 5.19.12 SETDGCLUT: Set DGC LUT (C1h) */
	mipi_dsi_dcs_write_seq(dsi, HX8394_CMD_SETDGCLUT,
			       0x00, 0x07, 0x0e, 0x16, 0x1e, 0x26, 0x2e, 0x37, 0x3f, 0x48, 0x50, 0x57, 0x5f, 0x67, 0x6e, 0x76, 0x7d, 0x85, 0x8c, 0x94, 0x9c, 0xa4, 0xab, 0xb3, 0xba, 0xc1, 0xc9, 0xd1, 0xd9, 0xe0, 0xe6, 0xed, 0xf5, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);

	/* 5.19.17 SETPANEL (CCh) */
	mipi_dsi_dcs_write_seq(dsi, HX8394_CMD_SETPANEL,
			       0x09);

	/* Unknown command, not listed in the HX8394-F datasheet (C7h) */
	mipi_dsi_dcs_write_seq(dsi, HX8394_CMD_UNKNOWN6,
			       0x00, 0xC0, 0x40, 0xC0);
	...
	/* Unknown command, not listed in the HX8394-F datasheet (BCh) */
	mipi_dsi_dcs_write_seq(dsi, HX8394_CMD_UNKNOWN7,
			       0x07);
...
static const struct hx8394_panel_desc boe_tv070wsm_tl0_desc = {
	.mode = &boe_tv070wsm_tl0_mode,
	.lanes = 4,
	.mode_flags = MIPI_DSI_MODE_VIDEO | MIPI_DSI_MODE_VIDEO_BURST,
	.format = MIPI_DSI_FMT_RGB888,
	.init_sequence = boe_tv070wsm_tl0_init_sequence,
};
...
static const struct of_device_id hx8394_of_match[] = {
	...
	{ .compatible = "boe,tv070wsm-tl0", .data = &boe_tv070wsm_tl0_desc },
	{ /* sentinel */ }
};
